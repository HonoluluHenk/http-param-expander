...
describe('FormParamExpander', () => {
  testSuite(
    () => new FormParamExpander(new PrimitivesFormatter()),
    {
      paramName: 'color',
      simple: 'blue',
    ...
    },
    {
      ...
      array: {
        ...
        exploded: {
          ...
          onArrayWithEmptiesExpect: 'color=blue&color=black&color=brown',
        },
      },
      object: {
        plain: {
          ...
          onObjectWithEmptiesExpect: 'color=R,100,G,200,B,150',
        },
        exploded: {
          onEmptyObjectExpect: '',
